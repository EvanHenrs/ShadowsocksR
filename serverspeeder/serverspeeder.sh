...
#安装包下载地址
INSTALLPACK=https://github.com/EvanHenrs/ShadowsocksR/raw/main/serverspeeder/91yunserverspeeder.tar.gz?raw=true
#判断版本支持情况的地址
CHECKSYSTEM=https://github.com/EvanHenrs/ShadowsocksR/raw/main/serverspeeder/serverspeederbin.txt
#bin下载地址
